...
const CONFIG = {
  ...
  STARTER_LOGO: 'logo2.jpg', // 普通logo图片 示例：/images/starter/logo/logo.svg
  STARTER_LOGO_WHITE: 'logo-white2.png', // 透明底浅色logo 示例： /images/starter/logo/logo-white.svg
  ...
  STARTER_HERO_TITLE_2: '成品支架、抗震支架、装配式预制模块、预制构件', // 英雄区文字
  // 英雄区两个按钮，如果TEXT留空则隐藏按钮
  STARTER_HERO_BUTTON_1_TEXT: '快速体验', // 英雄区按钮
  STARTER_HERO_BUTTON_1_URL:
    'https://chanyeyuan.amreal.cc/ksty', // 英雄区按钮
  STARTER_HERO_BUTTON_2_TEXT: '最新公告', // 英雄区按钮
  STARTER_HERO_BUTTON_2_URL: 'https://chanyeyuan.amreal.cc/about', // 英雄区按钮
  STARTER_HERO_BUTTON_2_ICON: '', // 英雄区按钮2的图标，不需要则留空

  // 英雄区配图，如需隐藏，改为空值即可 ''
  STARTER_HERO_PREVIEW_IMAGE: '/images/starter/hero/jidianmokuai.png', // 产品预览图 ，默认读取public目录下图片
  ...
  STARTER_FEATURE_TEXT_1: '装配式机电产品的优势', // 特性
  STARTER_FEATURE_TEXT_2:
    '高校建造，快速履约', // 特性

  STARTER_FEATURE_1_TITLE_1: '丰富的产品体系', // 特性1
  STARTER_FEATURE_1_TEXT_1: '涵盖支吊架、管线模组、桥架、工艺管道等全系列产品', // 特性1
  STARTER_FEATURE_1_BUTTON_TEXT: '了解更多', // 特性1
  STARTER_FEATURE_1_BUTTON_URL: 'https://noteforms.com/forms/4vx4pd', // 特性1

  STARTER_FEATURE_2_TITLE_1: '定制化设计服务', // 特性2
  STARTER_FEATURE_2_TEXT_1: '提供BIM深化、应力计算、物料清单、施工图等设计方案', // 特性2
  STARTER_FEATURE_2_BUTTON_TEXT: '了解更多', // 特性2
  STARTER_FEATURE_2_BUTTON_URL:
    'https://noteforms.com/forms/4vx4pd', // 特性2

  STARTER_FEATURE_3_TITLE_1: '高效生产与交付', // 特性3
  STARTER_FEATURE_3_TEXT_1: '自有生产基地，标准化流程，确保项目准时交付', // 特性3
  STARTER_FEATURE_3_BUTTON_TEXT: '了解更多', // 特性3
  STARTER_FEATURE_3_BUTTON_URL: 'https://noteforms.com/forms/4vx4pd', // 特性3

  STARTER_FEATURE_4_TITLE_1: '完善的售后支持', // 特性4
  STARTER_FEATURE_4_TEXT_1: '提供现场安装培训、技术指导，确保施工质量', // 特性4
  STARTER_FEATURE_4_BUTTON_TEXT: '了解更多', // 特性4
  STARTER_FEATURE_4_BUTTON_URL: 'https://noteforms.com/forms/4vx4pd', // 特性4

  // 首页ABOUT区块
  STARTER_ABOUT_ENABLE: true, // ABOUT区块开关
  STARTER_ABOUT_TITLE: '一套装配式机房高效智能解决方案',
  STARTER_ABOUT_TEXT:
    '我们专注于装配式机房系统、预制模块化产品，致力于为客户提供高效、可靠、经济的一体化解决方案。',
  ...
  // 嵌入外部表单
  STARTER_CONTACT_MSG_EXTERNAL_URL: 'https://noteforms.com/forms/4vx4pd', // 基于NoteForm创建，将留言数据存在Notion中
  //   自定义留言表单，以下几个配置暂时废弃
